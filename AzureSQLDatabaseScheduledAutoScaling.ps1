...
.PARAMETER serverName
    Azure SQL Database server name. Do not use the fully qualified name. Leave out the .database.windows.net.
...
.EXAMPLE
    ...
    -scalingSchedule [{WeekDays:[3], StartTime:"00:00:00", StopTime:"23:59:59", Edition: "Standard", Tier: "S2"}, {WeekDays:[2,3,4,5], StartTime:"06:59:59", StopTime:"17:59:59", Edition: "Premium", Tier: "P1"}]
...
[parameter(Mandatory=$false)]
[string] $defaultEdition = "Premium",

[parameter(Mandatory=$false)]
[string] $defaultTier = "P1"
)
...
# Write-Output "Set subscription." | timestamp
